...
/* ===============Verify Result=========== */
WebUI.waitForElementPresent(findTestObject("Object Repository/Page_Login/AttributeTitle_Header Login Form"),2)
def Notification_Error = WebUI.getText(findTestObject("Object Repository/Page_Login/AttributeTitle_Header Login Form"))
WebUI.verifyEqual(Notification_Error, verify_result)
