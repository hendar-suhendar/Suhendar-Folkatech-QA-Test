...
/* ===============Verify Result=========== */
WebUI.waitForElementPresent(findTestObject("Object Repository/Page_Dashboard/header_title dashboard"),2)
def Title_Dashboard = WebUI.getText(findTestObject("Object Repository/Page_Dashboard/header_title dashboard"))
WebUI.verifyEqual(Title_Dashboard, verify_result)
